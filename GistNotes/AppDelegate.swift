...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let backMenuVC = BackgroundMenuTableViewController()
        ...
        let revealVC = SWRevealViewController(rearViewController: backMenuVC, frontViewController: navigationController)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "GistNotes")
